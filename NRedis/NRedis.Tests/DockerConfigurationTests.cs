...
namespace NRedis.Tests
{
    ...
    public class DockerConfigurationTests
    {
        ...
        public void ContainerToolsVersion_ShouldBeRecentVersion()
        {
            ...
            {
                parsedVersion.Major.Should().BeGreaterThanOrEqualTo(1, "should use a modern version of Container Tools");
                parsedVersion.Minor.Should().BeGreaterThanOrEqualTo(0, "version should be valid");
            }
            else
            {
